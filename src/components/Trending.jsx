    ...
    <div className="trending" ref={carouselRef}>
      {trendingMovie.map((item, index) => (
        <div key={index} className="carousel">
          {console.log(item)}
          <img className="carousel__image" src={item.thumbnail.trending.small.substring(1)} 
          ...
          <div className="trending__content">
            <div className="trending__content--data">
              ...
              <span >
                {item.category === "Movie" ? (
                  <img className="movie" src={movieLogo} alt="Movie Logo" className="movie" />
                ) : (
                  <img className="series" src={seriesLogo} alt="Series Logo" className="series" />
                )}
              </span>
